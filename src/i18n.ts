...
const resources = {
  en: {
    translation: {
      navbar: { home: "Home", services: "Services", about: "About Us", howWeWork: "Our Solution", news: "Why JAF", contact: "Contact", getQuote: "Get a Quote" },
      footer: {
        rights: "JAF DEMENAGEMENTS", international: "International, National Moving & Storage",
        partnerEyebrow: "International Partner Network", trustedPartner: "Trusted Partner in", morocco: "Morocco",
        tagline: "International relocation specialists delivering safe, seamless moves across the globe since 1950.",
        quickLinks: "Quick Links", policies: "Policies & Documents", offices: "Offices", yearsExp: "Yrs exp."
      },
      hero: {
        slide1: { title: "Moving and Air Freight", subtitle: "Fast Global Air Cargo", description: "Time-critical air freight solutions with secure handling, customs coordination, and reliable worldwide delivery." },
        slide2: { title: "Moving and Road Transport", subtitle: "Reliable Overland Logistics", description: "Flexible road transport across local and cross-border routes with clear communication and on-time performance." },
        slide3: { title: "Moving and Sea Freight", subtitle: "Cost-Effective Ocean Shipping", description: "FCL and LCL sea freight services designed for dependable transit times and competitive international shipping costs." },
      ...
      news: {
        eyebrow: "WHY JAF", title: "Why Choose JAF", updates: "Benefits", description: "Discover why JAF Logistics is the trusted leader in relocation and freight services.", viewAll: "Learn more", readMore: "Read more",
        pageTitle: "Why JAF", pageDesc: "Discover the expertise and legacy of JAF Logistics, your trusted partner.", search: "Search...", filter: "Filter", empty: "No results found.",
        recentLabel: "Why JAF", recentTitle: "About Us", readAnother: "Learn more", swipe: "Swipe →", loading: "Loading...",
        support: "Priority Support", needHelp: "Need help?", supportDesc: "Our team of experts is available to assist you.", directCall: "Direct Call"
      },
      contact: {
      ...
      howWeWork: {
        legacy: "About Us", established: "Established in the",
      ...
      svcDetails: {
        ...
        ctaSub: "Our team is available 6 days a week to answer your questions.", ctaBtn: "(+216) 52 757 510 — Call us now", more: "Explore more", otherSvc: "Other Services", quote: "Get a Free Quote — (+216) 52 757 510"
      },
      servicesData: {
        ...
        "relocalisation-d'animaux": {
          title: "Pet Relocation", subtitle: "Safe, stress-free moves for your furry family", description: "Safe pet moving services with documentation support, route planning, and welfare-first handling.", longDescription: "Moving your pet internationally requires specialized knowledge of veterinary entry requirements, airline regulations, and quarantine rules. JAF Logistics coordinates health certificates, CITES permits when needed, approved crate sizing, and door-to-door care so your animals travel as safely and comfortably as possible.",
          f0: "Veterinary health certificate assistance", f1: "Airline-approved crate supply", f2: "Quarantine & import permit management", f3: "Microchip & vaccination coordination", f4: "Door-to-door pet delivery", f5: "24/7 welfare monitoring"
        },
        "service-de-dedouanement": {
          title: "Customs Clearance Service", subtitle: "Smooth border transitions", description: "Expert handling of customs documentation and clearance procedures.", longDescription: "JAF Logistics provides comprehensive customs clearance services, ensuring your shipments pass borders without delay. Our experts handle all documentation, duties, and compliance requirements.",
          f0: "Import & export clearance", f1: "Tariff classification", f2: "Duty & tax calculation", f3: "Regulatory compliance", f4: "Documentation preparation", f5: "Fast-track processing"
        },
        "office-moving": {
  ...
  fr: {
    translation: {
      ...
      servicesData: {
        ...
        "pet-relocation": {
          title: "Relocalisation d'Animaux", subtitle: "Un transfert serein pour votre ami", description: "Services dédiés au transport d'animaux incluant les formalités sanitaires.", longDescription: "Déménager votre animal à l'étranger nécessite une connaissance spécialisée des exigences vétérinaires et d'importation. JAF Logistics coordonne les certificats de santé, la documentation de transport et la livraison de porte à porte de vos animaux de compagnie.",
        ...
        "service-de-dedouanement": {
          title: "Service de Dédouanement", subtitle: "Passage aux frontières fluide", description: "Gestion experte des documents douaniers et des procédures de dédouanement.", longDescription: "JAF Logistics offre des services complets de dédouanement, assurant le passage de vos expéditions sans délai. Nos experts gèrent l'ensemble de la documentation, des droits de douane et des exigences de conformité.",
          f0: "Dédouanement import & export", f1: "Classification tarifaire", f2: "Calcul des droits et taxes", f3: "Conformité réglementaire", f4: "Préparation des documents", f5: "Traitement accéléré"
        },
        "office-moving": {
